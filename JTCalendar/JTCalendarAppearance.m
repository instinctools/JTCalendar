...
- (void)setDefaultValues {
	self.isSelectableFutureDays = YES;
	self.selectedWeekViewBackgroundColor = [UIColor whiteColor];
	self.weekViewBackgroundColor = [UIColor whiteColor];
    self.selectedWeekTextColor = [UIColor blackColor];
    self.selectedWeekTextFont = [UIFont systemFontOfSize:[UIFont systemFontSize]];
	self.shouldHighlightWeek = NO;
	self.isWeekMode = NO;
    ...
    self.weekViewBackgroundColor = [UIColor clearColor];
